...
const TAB_ITEMS = [
  ...
  },
  {
    ...
    sections: [
      {
        title: 'grok2api',
        desc: '注册成功后自动导入到 grok2api 管理后台（新版：admin 用户名 + 密码登录）',
        fields: [
          { key: 'grok2api_url', label: 'API URL', placeholder: 'http://127.0.0.1:8011' },
          { key: 'grok2api_admin_user', label: 'Admin 用户名', placeholder: '默认 admin' },
          { key: 'grok2api_app_key', label: 'Admin 密码', secret: true, placeholder: 'grok2api 管理端登录密码' },
        ],
      },
    ],
  },
