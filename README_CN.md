...
4. 查看 `logs/backend.log` 中的 Solver 日志
...
| 微信支付 | 支付宝 |
|---------|--------|
| <img src="docs/images/mm_facetoface_collect_qrcode_1775206373527.png" width="200" alt="微信支付" /> | <img src="docs/images/mm_facetoface_collect_qrcode_1775206373527.png" width="200" alt="支付宝" /> |
